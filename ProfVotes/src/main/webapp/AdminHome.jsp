...
<body >
    <nav class="upperNav">
        <ul><li style="float: left; color: aliceblue;  justify-content: center; font-size: 30px;
            ...
            <li><a href=""><i class="fa fa-tasks" ></i> Manage Voters</a></li>
            <li><a href=""><i class="fa fa-comment"></i> Vote Review</a></li>
    ...
    <div class="showProf">
        <table >
            ...
            <tr>
                <th>Gender</th>
                <td id="voterGen">${admin.gender}</td>
            </tr>
            <tr>
                <th>Mobile Number</th>
                <td>${admin.mobile}</td>
